...
export async function updateAllSettingsController(req: Request, res: Response) {
  try {
...
export async function upsertHospitalInfoController(req: Request, res: Response) {
  try {
...
export async function upsertContactController(req: Request, res: Response) {
  try {
...
export async function upsertPrefixesController(req: Request, res: Response) {
  try {
...
export async function upsertBillingController(req: Request, res: Response) {
  try {
...
export async function upsertDocumentsController(req: Request, res: Response) {
  try {
...
export async function upsertEmailController(req: Request, res: Response) {
  try {
...
export async function upsertStorageController(req: Request, res: Response) {
  try {
