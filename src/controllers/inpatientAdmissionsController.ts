 ...
 */
export const getInpatientAdmissions = async (req: Request, res: Response) => {
  try {
 ...
 * Fetch all inpatient admission records (joined with patient data)
 */
export const getInpatientAdmissionsByPatientId = async (req: Request, res: Response) => {
  try {
 ...
 */
export const createInpatientAdmission = async (req: Request, res: Response) => {
  try {
 ...
 */
export const viewInpatientAdmission = async (req: Request, res: Response) => {
  try {
 ...
 */
export const updateInpatientAdmission = async (req: Request, res: Response) => {
  try {
    const admissionId = req.params.id;
    const admissionData = req.body;
 ...
 */
export const deleteInpatientAdmission = async (req: Request, res: Response) => {
  try {
    const admissionId = req.params.id;
 ...
 */
export const dischargeInpatientAdmission = async (req: Request, res: Response) => {
  try {
...
export const getDischargeSummaryByAdmissionId = async (req: Request, res: Response) => {
  try {
    const admissionId = req.params.id;
 ...
 */
export const getLatestDiagnosisForAdmission = async (req: Request, res: Response) => {
  try {
