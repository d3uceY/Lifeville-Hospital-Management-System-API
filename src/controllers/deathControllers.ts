...
export const getDeathRecords = async (req: Request, res: Response) => {
  try {
...
export const createDeathRecord = async (req: Request, res: Response) => {
  try {
...
export const deleteDeathRecord = async (req: Request, res: Response) => {
  try {
    const { id } = req.params;
...
export const updateDeathRecord = async (req: Request, res: Response) => {
  try {
    const { id } = req.params;
