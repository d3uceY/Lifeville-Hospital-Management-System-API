...
export const getPatientStatusDistribution = async (req: Request, res: Response) => {
    try {
...
export const getStaffRolesDistribution = async (req: Request, res: Response) => {
    try {
...
export const getAppointmensToday = async (req: Request, res: Response) => {
    try {
...
export const getLabTestPending = async (req: Request, res: Response) => {
    try {
