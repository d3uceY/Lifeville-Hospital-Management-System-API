...
export const updateBedType = async (req: Request, res: Response) => {
  try {
...
export const getBedGroups = async (req: Request, res: Response) => {
  try {
...
export const createBedGroup = async (req: Request, res: Response) => {
  try {
...
export const updateBedGroup = async (req: Request, res: Response) => {
  try {
...
export const deleteBedGroup = async (req: Request, res: Response) => {
  try {
    const groupId = req.params.id;
...
export const getBedData = async (req: Request, res: Response) => {
  try {
...
export const viewBed = async (req: Request, res: Response) => {
  try {
