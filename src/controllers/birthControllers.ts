...
export const getBirthRecords = async (req: Request, res: Response) => {
  try {
...
export const updateBirthRecord = async (req: Request, res: Response) => {
  try {
    const { id } = req.params;
...
export const createBirthRecord = (req: Request, res: Response) => {
  try {
...
export const deleteBirthRecord = async (req: Request, res: Response) => {
  try {
    const { id } = req.params;
