...
export const getPaginatedPatientVisits = async (req: Request, res: Response) => {
    try {
...
export const getPatientVisitsByPatientId = async (req: Request, res: Response) => {
    try {
...
export const checkOutPatientVisit = async (req: Request, res: Response) => {
    try {
