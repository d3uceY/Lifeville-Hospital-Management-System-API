...
router.post('/ai/generate/physical-exam-findings', veryStrictRateLimiter, generatePhysicalExamFindingsText);
router.post('/ai/generate/lab-test-comment', strictRateLimiter, generateLabTestCommentText);
router.post('/ai/generate/diagnosis-suggestion', veryStrictRateLimiter, generateDiagnosisSuggestionText);
