...
export const polishComplaintText = async (req: Request, res: Response) => {
    try {
        const { text } = req.body;
...
export const polishDoctorNoteText = async (req: Request, res: Response) => {
    try {
        const { text } = req.body;
        if (!text) return res.status(400).json({ success: false, message: 'text is required' });
...
export const polishNurseNoteText = async (req: Request, res: Response) => {
    try {
        const { text } = req.body;
        if (!text) return res.status(400).json({ success: false, message: 'text is required' });
...
export const polishLabTestResultText = async (req: Request, res: Response) => {
    try {
        const { text } = req.body;
        if (!text) return res.status(400).json({ success: false, message: 'text is required' });
...
export const generatePhysicalExamFindingsText = async (req: Request, res: Response) => {
    try {
...
export const generateLabTestCommentText = async (req: Request, res: Response) => {
    try {
...
export const getCachedPatientSummary = async (req: Request, res: Response) => {
    try {
...
export const getAIPatientSummary = async (req: Request, res: Response) => {
    try {
        const { patientId } = req.params;
...
export const generateDiagnosisSuggestionText = async (req: Request, res: Response) => {
    try {
